...
const Login = () => {
    return (
        <div>
            <div className=" flex justify-between gap-10 sm:mt-28 mt-12 w-[1400px] login_wrap mx-auto">
                ...
                <div className="login_wrap w-full lg:ml-auto lg:mx-0 mx-auto sm:pt-12 pt-0">
                    <p className='OnestMedium text-3xl text-[#101010] text-center mb-2'> Welcome back 👋 </p>
                        ...
                        <form>
                            ...
                            <div className="mb-3">
                                ...
                                <div className='relative'>
                                    ...
                                    <input type="password" id="password" className="bg-white border border-[#001C001A] text-[#101010] text-sm rounded-[4px] focus:ring-[#101010] focus:border-[#101010] block w-full p-2.5 pl-12 h-[50px] OnestRegular placeholder:text-[#001C0033]" placeholder="Search" required />
                            ...
                            <div className=' text-right'>
                                <Link to="" className=' text-[#101010] text-sm OnestMedium text-right'>
                                    Forgot password?
                                </Link>
                            </div>

                            <div className=' mt-16'>
                                <button type='submit' className=' w-full h-[50px] bg-[#101010] text-white rounded-[5px] OnestMedium hover:opacity-[0.9] ease-in-out duration-150 flex justify-center items-center gap-3'>
                                    Login
                                    <span>
