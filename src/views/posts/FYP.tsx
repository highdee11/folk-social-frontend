        ...
        <ul className="space-y-5 w-full flex justify-between items-start flex-col h-[900px] overflow-y-scroll">
            ...
            <li className="w-full">
                <div className=" w-[600px] post_box mx-auto dark:bg-darkFaintGray bg-[#F9F9F9] rounded-[8px] pt-5">
                    ...
                    <div className=" flex justify-between items-start pb-2 px-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className=" text-grayText OnestLigh dark:text-gray-200"> 623 followers</p>
                                <p className=" text-grayText OnestLight dark:text-gray-200"> 2w</p>
                            </div>
                        </div>
                    ...
                    <div className="px-4">
                        <p className=" text-darkColor dark:text-gray-200 text-base OnestRegular">
