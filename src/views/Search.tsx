    ...
    return (
        <div className="md:w-[600px] w-[97%] bg-white dark:bg-darkColor rounded-sm shadow-sm mt-12 mx-auto pt-8 px-5 pb-12">
            ...
            <div className=" flex justify-start items-center gap-4 border-b-[0.2px] border-b-grayText dark:border-b-white pb-4">
                ...
                <div>
                    <p className=" text-darkColor dark:text-white OnestRegular">Find Friends nd accounts that you like</p>
                    <p className="text-darkColor dark:text-white OnestRegular">Try following five or more accounts    for a persoalised experience.</p>
                </div>
            </div>
            ...
            <div>
                <div className="mt-8">
                    <div className='relative'>
                        <span className=' absolute bottom-3 left-4 text-darkColor dark:text-white'>
                        ...
                        <input type="text" id="search" className="bg-transparent dark:bg-transparent border  border-[#001C001A]  dark:border-white text-[#101010]  dark:text-white text-sm rounded-[4px] focus:ring-[#101010] dark:focus:ring-white focus:border-[#101010] block w-full p-2.5 pl-12 h-[45px] OnestRegular placeholder:text-[#001C0033] dark:placeholder:text-white" placeholder="Search" required />
                    </div>
                            ...
                            <li>
                                <div className=" flex justify-between items-center border-b-[0.5px] border-b-[rgba(16,16,16,0.24)] dark:border-b-grayText pb-3">
                                    <div className="flex justify-start items-center gap-3">
                                        ...
                                        <div>
                                            <p className=" text-darkColor dark:text-white OnestMedium text-sm">John Doe</p>
                                            <p className=" text-grayText dark:text-white OnestLight text-xs">JohnDoeAll</p>
                                            <p className=" text-grayText dark:text-white OnestLight text-xs">Suggested for you</p>
                                        </div>
                                    </div>
