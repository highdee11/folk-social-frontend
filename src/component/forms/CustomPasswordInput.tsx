        ...
        <>
            <label htmlFor={name} className="block mb-2 text-sm OnestRegular text-[#101010] dark:text-grayText">{label}</label>
                <div className='relative'>
                    <span className=' text-black dark:text-white absolute bottom-0 top-0 m-auto h-fit w-fit left-4'>
                        <svg width="21" height="21" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.8" d="M12.3176 7.08603V5.47578C12.3176 3.59103 10.7891 2.06253 8.90431 2.06253C7.01956 2.05428 5.48506 3.57528 5.47681 5.46078V5.47578V7.08603" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M11.7624 15.937H6.03162C4.46112 15.937 3.18762 14.6642 3.18762 13.093V9.87623C3.18762 8.30498 4.46112 7.03223 6.03162 7.03223H11.7624C13.3329 7.03223 14.6064 8.30498 14.6064 9.87623V13.093C14.6064 14.6642 13.3329 15.937 11.7624 15.937Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
