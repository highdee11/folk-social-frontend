    ...
    return (
        <>
            ...
            <aside 
                ...
                className="fixed top-0 left-0 z-40 w-[240px] h-full transition-transform -translate-x-full lg:translate-x-0"
                aria-label="Sidebar">
            ...
            <div className="lg:w-[calc(100%-322px)] w-full h-full lg:mx-auto mx-auto ml-auto lg:mr-10 mr-auto">
                <div className="flex flex-col justify-between h-full relative">
                    <div className="h-[calc(100%-50px)] md:h-full">
                        <Outlet />
                    </div>

                    {/* Bottom Navs here */}
                    <div className="absolute bottom-0 left-0 right-0 w-full z-10 h-[50px] bg-red sm:hidden">
