...
const WhoToFollow = ()=> {
    ...
    return (
        <div className=" w-[350px] min-w-[350px] mini_post h-fit bg-white dark:bg-darkColor dark:border dark:border-grayText  rounded-[8px] px-5 py-8 md:block hidden">
                    <p className=" OnestRegular text-lg pb-6 text-darkColor dark:text-gray-200">
                        Who to follow
                    </p>
                        ...
                        <li>
                            <div className=" flex justify-between items-center border-b-[0.5px] border-b-[rgba(16,16,16,0.24)] dark:border-b-grayText pb-3">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <p className=" text-darkColor dark:text-gray-200 OnestMedium">John Doe</p>
                                        <p className=" text-grayText dark:text-gray-200 OnestLight"> Industry</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <p className="text-base text-darkColor dark:text-gray-200 OnestRegular">Follow</p>
                                </div>
